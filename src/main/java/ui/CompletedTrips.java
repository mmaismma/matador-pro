...
public class CompletedTrips extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CompletedTrips
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompletedTrips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompletedTrips().setVisible(true);
            }
        });
    }
