...
public class UpcommingTrips extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UpcommingTrips
     */
    public UpcommingTrips() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpcommingTrips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpcommingTrips().setVisible(true);
            }
        });
    }
